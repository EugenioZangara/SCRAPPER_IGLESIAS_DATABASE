    ...
    if perfil.parroquias_favoritas.filter(pk=pk).exists():
        ...
        return JsonResponse({
            ...
            "parroquia": {
                ...
                "imagen_url": parroquia.imagen_url or "",
...
def robots_txt(request):
    content = (
        ...
        "Disallow: /publico/*/reportar-horario/\n"
        "Disallow: /publico/*/validar-horario/\n"
        "Disallow: /publico/*/votar-horario/\n"
        "Disallow: /publico/*/comentar/\n"
        "Disallow: /publico/*/contacto/\n"
        "\n"
        "User-agent: GPTBot\n"
        "Allow: /\n"
        "\n"
